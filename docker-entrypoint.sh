...
networkname ${NETWORKNAME:-VPN$RANDOM}
...
initpeers ${INITPEERS:-example.com 7000}
...
enabletunneling ${ENABLETUNNELING:-yes}
...
ifconfig4 ${IFCONFIG4:-172.16.254.$(expr $RANDOM % 256)/24}
